...
void loop()
{
  scrollStep = 1; sx = 1; sy = 1; scrollDelay = 10; offsY = (SCR_WD-1-rFont->ht*sy)/2;
  //scrollString("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+-!?.: ");
  scrollString("This is an example of super-smooth scrolling with ordinary Arduino, ST7735 128x168 LCD library and large RRE font ...    ");
}
